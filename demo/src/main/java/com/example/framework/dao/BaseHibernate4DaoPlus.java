 ...
 */
@Repository
public class BaseHibernate4DaoPlus<E extends Serializable> extends BaseHibernate4Dao<E> implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if(this.dynamicQueryBuilder == null){
            this.dynamicQueryBuilder = new DynamicQueryBuilderImpl();
            ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
            dynamicQueryBuilder.setResourceLoader(resolver);
            dynamicQueryBuilder.setFileNames(Collections.singletonList("classpath*:/query/*.xml").toArray(new String[1]));
        }
        dynamicQueryBuilder.init();
        Map<String,String> namedHQLQueries = dynamicQueryBuilder.getNamedHQLQueries();
        Map<String,String> namedSQLQueries = dynamicQueryBuilder.getNamedSQLQueries();
    ...
    public void setDynamicQueryBuilder(DynamicQueryBuilder dynamicQueryBuilder) {
